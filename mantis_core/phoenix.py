...
from mantis_core.execution.adapter_base import (  # noqa: E402
    OrderIntent,
    OrderSide,
    OrderType,
)
from mantis_core.execution.safety import (  # noqa: E402
    ExecutionSafetyConfig,
    ExecutionSovereignGuard,
)
from mantis_core.zkp import SovereigntyCommitment  # noqa: E402
    ...
    def emit_audit_report(self, final_account: Any) -> Path:
        ...
        try:
            ...
            if self.invariants_passed and self._strategy_commitment:
                from mantis_core.ledger import StrategyLedger  # noqa: PLC0415
