...
from mantis_core.paths import _safe_mkdir
...
class TestFlightRecorder:
    ...
    def test_record_error(self, tmp_path):
        from mantis_core.phoenix import FlightRecorder
...
class TestRunnerResilience:
    ...
    def test_runner_survives_gate_crash(self):
        ...
        with patch("mantis_core.runner.evaluate_gates", side_effect=RuntimeError("GATE BOMB")):
    ...
    def test_runner_survives_metric_extraction_crash(self):
        ...
        with patch("mantis_core.runner.evaluate_gates", return_value="not_a_list"), \
             patch("mantis_core.runner._status_from_gate_results", side_effect=TypeError("bad type")):
            result = runner.run_simulation(mock_ctx)
...
class TestCLISafeRun:
    ...
    def test_safe_run_catches_exception(self):
        from mantis_core.cli import _safe_run
        from mantis_core.phoenix import FlightRecorder
        FlightRecorder._instance = None
