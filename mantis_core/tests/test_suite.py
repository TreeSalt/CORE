...
from mantis_core.autonomy import load_snapshot
from mantis_core.calibration import _run_one
from mantis_core.cli import cmd_validate
...
from mantis_core.gates import GateResult, _run_sim, _status_from_gate_results, evaluate_gates
from mantis_core.models import MetricSet, SimulationResult
from mantis_core.registry import load_registry, promote_to_staging
from mantis_core.strategies import REGISTRY, V032Simple
...
class TestSuite(unittest.TestCase):
    ...
    @patch("mantis_core.runner.evaluate_gates")
    ...
    def test_sharpe_gate(self) -> None:
        with patch("mantis_core.gates._run_sim") as mock_sim:
            # Low Sharpe
    ...
    @patch("mantis_core.gates.load_ohlc")
    @patch("mantis_core.gates._calc_annual_vol")
    ...
    # --- CLI & AUTONOMY TESTS ---
    @patch("mantis_core.cli._run_one")
