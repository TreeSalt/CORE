...
class TestCliAlias(unittest.TestCase):
    ...
    @patch("mantis_core.cli.save_snapshot")
    @patch("mantis_core.cli.walk_forward_validation")
    @patch("mantis_core.cli.promote_to_staging")
    @patch("mantis_core.cli.load_snapshot")
