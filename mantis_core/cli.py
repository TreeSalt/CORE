...
from mantis_core.council import run_council_sweep
from mantis_core.data import MarketTape, load_ohlc
from mantis_core.emit import unique_signals
from mantis_core.engine import run_backtest
from mantis_core.gates import evaluate_gates
from mantis_core.paths import DATA_DIR, REPO_ROOT, REPORT_DIR, ensure_dirs
...
from mantis_core.portfolio_regime_report import generate_regime_report
...
from mantis_core.reality_gap import run_reality_gap
...
from mantis_core.strategies import REGISTRY, get_strategy
from mantis_core.strategies.catalog import STRATEGY_CATALOG
from mantis_core.strategies.registry import STRATEGY_REGISTRY
from mantis_core.sweep import run_sweep
from mantis_core.utils import infer_periods_per_year, safe_to_csv
from mantis_core.zip_verifier import cmd_verify
...
def cmd_validate(args: argparse.Namespace) -> None:  # noqa: PLR0915
    ...
    if not viability_path.exists() or not decision_path.exists():
        from mantis_core.capabilities import generate_capability_snapshot  # noqa: PLC0415
        from mantis_core.tradability import generate_viability_table  # noqa: PLC0415
...
def cmd_research_feed(args: argparse.Namespace) -> None:
    ...
    from mantis_core.execution.websocket_feed import WebSocketResearchFeed  # noqa: PLC0415
...
def build_parser() -> argparse.ArgumentParser:  # noqa: PLR0915
    p = argparse.ArgumentParser(prog="mantis_core", description="FORTRESS PROTOCOL harness")
...
def cmd_help_all(args: argparse.Namespace) -> None:
    ...
    print("-" * 60)
    print("Run any CLI command with -h for details. Example: 'python3 -m mantis_core.cli calibrate -h'")
...
def cmd_portfolio_backtest(args: argparse.Namespace) -> None:  # noqa: PLR0912, PLR0915
    ...
    if args.synthetic:
        ...
        if args.symbols == "auto":
            from mantis_core.capabilities import generate_capability_snapshot  # noqa: PLC0415
            from mantis_core.tradability import (  # noqa: PLC0415
    ...
    if op_mode == OperatingMode.ASSISTED and not is_authorized:
        ...
        from mantis_core.execution.fill_tape import FillRecord  # noqa: PLC0415
...
def _safe_run(func: Any, args: Any) -> None:  # noqa: ANN401
    ...
    try:
        ...
        from mantis_core.phoenix import FlightRecorder  # noqa: PLC0415
