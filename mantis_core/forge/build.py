...
def build_drop_packet(repo_root: Path, dist_dir: Path) -> Dict[str, Any]:  # noqa: PLR0915, PLR0912
    ...
    from mantis_core.tradability import generate_viability_table, select_viable_smoke_universe  # noqa: PLC0415
    ...
    if viable_universe:
        ...
        try:
            subprocess.check_call([
                sys.executable, "-m", "mantis_core.cli", "portfolio-backtest",
