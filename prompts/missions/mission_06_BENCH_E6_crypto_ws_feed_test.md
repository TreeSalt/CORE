# MISSION: Test for crypto_ws_feed
DOMAIN: 06_BENCHMARKING
TYPE: IMPLEMENTATION

## DELIVERABLE
File: 06_BENCHMARKING/tests/01_DATA_INGESTION/test_bench_crypto_ws_feed.py

## REQUIREMENTS
- Import module from 01_DATA_INGESTION/data_ingestion/crypto_ws_feed.py
